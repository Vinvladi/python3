...
# 3.2 Коллекции (часть 2)) len (s1)  (Также в len можно задавать строку (s1 = 'hello'))
# вывод 3.2 Коллекции (часть 2) в Shell : 5
...
# вывод 3.1 в Shell : 'd'
# 3.2 Коллекции (часть 2)) В python существует и другая нумерация индексов (0.2) ===>
# s[-1] 
# вывод 3.2 Коллекции (часть 2) в Shell : 'd'
# 
# ПОДТЕМА: СРЕЗЫ
...
# 3.2 Коллекции (часть 2)) при вводе s.count( - выходит подсказка, сколько элементов необходимо передать : s.count(sub[, start[, end]]) -> int
# sub - обозначает подстроку (sub - является обязательным) в тетрадке более наглядно стр 20 начало 
# 3.2 Коллекции (часть 2).1) s.count('o',6) - сколько нам встретилась o начиная с 6-ой позиции
# вывод 3.2 Коллекции (часть 2).1 в Shell: 1 (так как в строке позиция начинается с 0)
# 3.2 Коллекции (часть 2).2) s.count('o',8) (так как элемент находится на 8 позиции, но индекс у элемента 7)
# вывод 3.2 Коллекции (часть 2).2 в Shell: 0
